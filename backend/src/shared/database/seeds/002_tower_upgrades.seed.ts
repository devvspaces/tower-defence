...
const createUpgradeLevels = (
  ...
  return [
    // Level 1 (Base)
    {
      ...
      special_bonus_type: null,
      special_bonus_value: null,
      unlock_player_level: unlockLevels[0],
      upgrade_cost_currency: 'xp',
      upgrade_cost_amount: costs[0],
    },
    // Level 2
    {
      tower_type: towerType,
      ...
      special_bonus_type: null,
      special_bonus_value: null,
      unlock_player_level: unlockLevels[1],
      upgrade_cost_currency: 'xp',
      upgrade_cost_amount: costs[1],
    },
    // Level 3
    {
      tower_type: towerType,
      ...
      range_multiplier: 1.17,
      fire_rate_multiplier: 1.2,
      special_bonus_type: 'pierce',
      special_bonus_value: 1,
      unlock_player_level: unlockLevels[2],
      upgrade_cost_currency: 'xp',
      upgrade_cost_amount: costs[2],
    },
    // Level 4
    {
      tower_type: towerType,
      ...
      special_bonus_type: 'crit_chance',
      special_bonus_value: 0.25,
      unlock_player_level: unlockLevels[3],
      upgrade_cost_currency: 'xp',
      upgrade_cost_amount: costs[3],
    },
    // Level 5
    {
      tower_type: towerType,
      ...
      range_multiplier: 1.42,
      fire_rate_multiplier: 1.5,
      special_bonus_type: 'explosive',
      special_bonus_value: 20,
      unlock_player_level: unlockLevels[4],
      upgrade_cost_currency: 'xp',
      upgrade_cost_amount: costs[4],
    },
  ];
};
